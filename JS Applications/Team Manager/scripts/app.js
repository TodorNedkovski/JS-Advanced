import { homeViewHandler, aboutViewHandler, loginHandler, registerHandler, logoutHandler
    , catalogeHandler ,createCataloge, catalogueDetailsHandler
     ,joinTeamHandler, editTeamHandler, leaveTeamHandler} from './handlers.js'
import { error } from './services.js';
